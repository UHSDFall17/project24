...
<<<<<<< HEAD
				else {String url = "jdbc:mysql://35.192.76.117:3306/trello1?useSSL=false";// url
		        ...
		        try {
		            ...
		            String queryString = "SELECT * FROM usercreds where username = '" + username.getText() + "' and pwd='"+password.getText()+"'" ;
		            //set this values using PreparedStatement
		            ResultSet results = st.executeQuery(queryString); //where ps is Object of PreparedStatement
